...
##-------------------LLM(OpenAI)----------------##
load_dotenv()     #used for Hugging face token activation
...
st.sidebar.header("Your Information 👩‍💻")    #streamlit run app.py
